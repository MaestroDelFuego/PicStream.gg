...
**PicStream** is a locally hosted tool and **I am not responsible for the content users upload**. As the application is designed to run on your own local server, you are solely responsible for any media you upload, share, or distribute using the platform.

By using this application, you agree to:

- Ensure that the media you upload does not violate any copyright, intellectual property laws, or any other regulations.
- Avoid uploading illegal, offensive, or harmful content.
- Take full responsibility for how the uploaded media is shared and used.

Since this is a personal, locally hosted tool, the application does not impose any restrictions or content moderation. It is your responsibility to ensure compliance with local laws and respect for others' privacy and intellectual property rights.

The tool does not store any user-uploaded files long term unless you configure it to do so (e.g., through cloud storage). Any files stored locally will be stored on your server and will only be accessible via the public URL generated by LocalTunnel or other similar services.
